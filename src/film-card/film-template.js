export default (data) =>
  `<article class="film-card">
    ...
    <img src="${data.picture}" alt="" class="film-card__poster">
    <p class="film-card__description">${data.description}</p>
    <button class="film-card__comments">${data.comments}</button>

    <form class="film-card__controls">
      <button class="film-card__controls-item button "><!--Add to watchlist--> WL</button>
